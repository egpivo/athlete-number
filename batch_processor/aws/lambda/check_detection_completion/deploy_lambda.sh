...
LAMBDA_FUNCTION_NAME="athlete_number_detection_check_detection_completion"  # ✅ Fixed
LAMBDA_SRC_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
S3_BUCKET="athlete-number-detection"
S3_KEY="lambda_deployments/${LAMBDA_FUNCTION_NAME}.zip"  # ✅ Fixed
TMP_DIR="/tmp/lambda_package"
ZIP_FILE="${LAMBDA_FUNCTION_NAME}.zip"  # ✅ Fixed
